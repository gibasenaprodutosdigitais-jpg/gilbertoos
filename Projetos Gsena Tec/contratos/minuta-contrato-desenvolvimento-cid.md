...
As PARTES declaram e reconhecem, como premissa essencial deste contrato, que:

**(i)** O CONTRATANTE é o **idealizador, criador intelectual e único titular** da concepção, da estratégia, da arquitetura de negócio, da metodologia, do modelo operacional, das regras de negócio, da nomenclatura e do posicionamento de mercado de todos os projetos de tecnologia objeto deste contrato, incluindo, sem limitação, o **sistema OCEO**, o **Hub GSena** e os demais aplicativos, plataformas e soluções em modelo SaaS descritos no **ANEXO I**;

**(ii)** Tais projetos nasceram e se desenvolvem a partir do conhecimento técnico, da experiência empresarial, da carteira de clientes, da reputação, da marca e do nome do CONTRATANTE, ativos que lhe pertencem exclusivamente e que não se transferem, sob nenhuma hipótese, ao PRESTADOR;

**(iii)** O PRESTADOR é contratado **exclusivamente para executar, sob encomenda e sob a direção e as especificações do CONTRATANTE**, a implementação técnica dessa concepção, atuando como executor técnico e não como cocriador, coautor, sócio, parceiro ou coempreendedor dos projetos;

**(iv)** Toda a criação, o desenvolvimento e a implementação realizados pelo PRESTADOR configuram **obra sob encomenda e por conta e ordem do CONTRATANTE**, nos termos do art. 4º da Lei nº 9.609/1998 (Lei do Software) e dos arts. 49 e seguintes da Lei nº 9.610/1998 (Lei de Direitos Autorais), pertencendo os respectivos direitos, de forma **originária e exclusiva, ao CONTRATANTE**;

**(v)** O PRESTADOR terá acesso, no exercício de suas funções, a informações estratégicas, financeiras, tributárias, cadastrais e de clientes de altíssima sensibilidade, razão pela qual as obrigações de confidencialidade e de não concorrência aqui pactuadas são **condição essencial** deste contrato, sem as quais o CONTRATANTE não o celebraria.
...
## CLÁUSULA 2 — DO REGIME DA PRESTAÇÃO E DA AUSÊNCIA DE VÍNCULO

**2.1.** Os serviços serão prestados em caráter **autônomo**, sem subordinação hierárquica, pessoalidade obrigatória ou controle de jornada, não se estabelecendo, por este instrumento, vínculo empregatício, societário, de parceria, de consórcio, de agência ou de representação entre as PARTES ou entre o CONTRATANTE e eventuais auxiliares do PRESTADOR.

**2.2.** O PRESTADOR é o único responsável pelos encargos trabalhistas, previdenciários, fiscais e tributários incidentes sobre sua atividade e sobre a de seus eventuais auxiliares, obrigando-se a reembolsar integralmente o CONTRATANTE de qualquer valor que este venha a desembolsar a esse título, inclusive custas, honorários e despesas processuais.

**2.3.** O PRESTADOR poderá `[ ] / não poderá [ ]` subcontratar terceiros. Caso autorizado por escrito, o PRESTADOR permanece integral e solidariamente responsável pelos atos dos subcontratados e obriga-se a fazê-los assinar, previamente ao acesso a qualquer informação ou código, termo de confidencialidade e de **cessão total de direitos diretamente em favor do CONTRATANTE**, cuja via original será entregue ao CONTRATANTE. A subcontratação sem esse termo constitui infração grave, sujeita à multa da Cláusula 15.

---

## CLÁUSULA 3 — DAS OBRIGAÇÕES DO PRESTADOR

**3.1.** Obriga-se o PRESTADOR a:

**a)** executar os serviços com diligência, zelo técnico, boa-fé e observância das melhores práticas de mercado, das especificações do CONTRATANTE e da legislação aplicável;

**b)** desenvolver e manter **todo o código-fonte em repositório de titularidade do CONTRATANTE** (conta/organização do CONTRATANTE), com histórico de versões íntegro, sendo vedado manter o código exclusivamente em contas, repositórios, nuvens ou dispositivos pessoais do PRESTADOR;

**c)** entregar ao CONTRATANTE, de forma contínua e sempre que solicitado, e obrigatoriamente ao término ou rescisão do contrato: **(i)** o código-fonte completo, comentado, compilável e funcional; **(ii)** scripts de banco de dados, migrações e dados; **(iii)** documentação técnica, de arquitetura e de deploy; **(iv)** arquivos-fonte editáveis de design (protótipos, layouts, identidade); **(v)** todas as credenciais, chaves de API, senhas, tokens, certificados, domínios e acessos a serviços de terceiros; e **(vi)** relação de todas as bibliotecas, licenças e serviços de terceiros utilizados;

**d)** transferir para a titularidade do CONTRATANTE todos os domínios, registros, contas de infraestrutura, lojas de aplicativos, provedores de nuvem e serviços contratados em nome do PRESTADOR para uso nos projetos, no prazo de até 5 (cinco) dias corridos da solicitação;

**e)** **não inserir, em nenhuma hipótese**, no código ou nos sistemas, qualquer *backdoor*, *kill switch*, rotina de expiração, bloqueio remoto, código malicioso, coleta oculta de dados, dependência de licença pessoal do PRESTADOR ou qualquer mecanismo que possa comprometer, interromper, degradar ou condicionar o funcionamento das soluções — cuja violação constitui **infração gravíssima**, autorizando rescisão imediata, aplicação cumulativa da multa da Cláusula 15 e apuração de responsabilidade civil e criminal;

**f)** garantir que as entregas não violem direitos de terceiros, respondendo integral e exclusivamente por eventual reivindicação de titularidade, plágio, violação de patente, de direito autoral, de marca ou de licença de software;

**g)** manter o CONTRATANTE informado do andamento dos trabalhos, prestando contas em `[periodicidade: semanal / quinzenal]` por `[reunião / relatório escrito]`;

**h)** devolver ou destruir, ao término do contrato, conforme instrução do CONTRATANTE, todas as cópias de informações confidenciais, código, dados e materiais em seu poder, firmando declaração escrita de que nada retém.

**3.2. Software livre e de terceiros.** O PRESTADOR só poderá empregar componentes de terceiros sob **licenças permissivas** (MIT, Apache 2.0, BSD, ISC e equivalentes), sendo **vedado** o uso de componentes sob licenças *copyleft* ou recíprocas (GPL, AGPL, LGPL, SSPL e equivalentes) ou que imponham abertura, compartilhamento, comunicação pública do código-fonte ou restrição à exploração comercial das soluções, salvo autorização prévia e por escrito do CONTRATANTE. O PRESTADOR responde por todo prejuízo decorrente da violação desta cláusula.

---

## CLÁUSULA 4 — DAS OBRIGAÇÕES DO CONTRATANTE

**4.1.** Obriga-se o CONTRATANTE a: **(a)** fornecer as informações, especificações e definições de negócio necessárias à execução; **(b)** disponibilizar ou custear as licenças, ambientes e serviços de infraestrutura necessários; **(c)** validar as entregas nos prazos ajustados; e **(d)** efetuar o pagamento da remuneração na forma da Cláusula 5.
...
**5.3.** O atraso no pagamento sujeita o CONTRATANTE a multa de 2% (dois por cento), juros de 1% (um por cento) ao mês *pro rata die* e correção pelo `[IPCA]`. O atraso, contudo, **não autoriza o PRESTADOR a retirar, bloquear, ocultar, apagar ou retomar código, acessos, dados ou sistemas**, cabendo-lhe exclusivamente a via de cobrança judicial ou extrajudicial.

**5.4.** Correm por conta do PRESTADOR suas próprias despesas ordinárias (equipamento, internet, energia, deslocamento local). Despesas extraordinárias somente serão reembolsadas se prévia e expressamente autorizadas por escrito.

---

## CLÁUSULA 6 — DA PROPRIEDADE INTELECTUAL (CLÁUSULA ESSENCIAL)

**6.1. Titularidade.** Todos os direitos patrimoniais de autor e de propriedade intelectual e industrial sobre a totalidade dos resultados deste contrato pertencem, **de forma originária, exclusiva, integral, irrevogável, irretratável, perpétua, universal (para todos os países) e sem limitação de número de exemplares, mídias, tecnologias ou finalidades, ao CONTRATANTE**, na condição de encomendante e criador intelectual dos projetos.

**6.2. Abrangência.** A titularidade do CONTRATANTE alcança, sem limitação:

**a)** o **código-fonte** e o código-objeto, em todas as linguagens, versões, *branches*, *commits* e histórico de repositório;
**b)** a arquitetura de sistema, a modelagem de dados, os diagramas, os algoritmos, as regras de negócio, os fluxos e a lógica de funcionamento;
**c)** bancos de dados, estruturas de dados, dados tratados e derivados, bem como *datasets* de treinamento;
**d)** *prompts*, instruções, configurações, fluxos e arquiteturas de agentes de inteligência artificial, *fine-tunings* e integrações com modelos de linguagem;
...
**6.4. Registro.** O CONTRATANTE poderá registrar as criações em seu próprio nome, no Brasil e no exterior, sem necessidade de anuência, ciência prévia ou qualquer contrapartida adicional ao PRESTADOR. O PRESTADOR obriga-se a **não requerer, depositar, registrar ou reivindicar**, em nome próprio ou de terceiros, direta ou indiretamente, qualquer direito, marca, patente, domínio, conta em loja de aplicativos ou registro sobre as criações ou sobre sinais distintivos confundíveis com os do CONTRATANTE.

**6.5. Direitos morais.** Ressalvados os direitos morais irrenunciáveis por lei, o PRESTADOR, nos limites do art. 2º, § 1º, da Lei nº 9.609/1998, **renuncia ao exercício** de qualquer direito de oposição a modificações, adaptações, supressões ou evoluções das criações, bem como ao direito de exigir a indicação de seu nome, crédito, autoria ou menção em qualquer material, código, interface, documentação ou peça de comunicação, salvo autorização expressa e escrita do CONTRATANTE.

**6.6. Vedação de reuso.** É **expressamente vedado** ao PRESTADOR, durante e após a vigência, a qualquer título e por prazo indeterminado: **(a)** utilizar, copiar, reproduzir, adaptar, reaproveitar, licenciar, sublicenciar, ceder, vender, publicar, disponibilizar em repositório público ou privado, apresentar como portfólio, ou explorar comercialmente, total ou parcialmente, o código, a arquitetura, as regras de negócio, os *prompts*, o *design*, os dados ou qualquer criação objeto deste contrato; **(b)** desenvolver, para si ou para terceiro, solução que reproduza, imite, replique ou constitua obra derivada, ainda que com outra linguagem, marca, nome ou aparência, das soluções aqui criadas; e **(c)** apresentar-se, perante quem for, como cocriador, coautor, coproprietário, idealizador, sócio ou coempreendedor dos projetos.
...
**7.1. Definição.** Considera-se **Informação Confidencial** toda informação, em qualquer forma ou suporte, revelada ao PRESTADOR ou por ele conhecida em razão deste contrato, incluindo, sem limitação: código-fonte, arquitetura, *prompts*, credenciais, bases de dados, dados de clientes, contratos, propostas, tabelas de preço, custos, margens, faturamento, informações contábeis, fiscais, tributárias e financeiras do CONTRATANTE, de suas empresas, de seus sócios e de seus clientes; *business plans*, *valuation*, negociações e rodadas de investimento; estratégias, metodologias, *roadmaps*, projetos em concepção, ideias não implementadas; nomes e dados de clientes, prospectos, parceiros, fornecedores e colaboradores; e a própria existência e o teor deste instrumento.

**7.2. Obrigações.** O PRESTADOR obriga-se a: **(a)** manter absoluto sigilo; **(b)** usar a Informação Confidencial **exclusivamente** para a execução deste contrato; **(c)** não divulgar, comentar, publicar, mencionar em redes sociais, entrevistas, palestras, *podcasts*, portfólio, currículo ou proposta comercial; **(d)** não transmitir a terceiros, salvo a auxiliares indispensáveis e previamente autorizados por escrito, que tenham firmado termo de sigilo de igual rigor, permanecendo o PRESTADOR solidariamente responsável; e **(e)** adotar medidas técnicas e organizacionais adequadas de segurança da informação.

**7.3. Prazo.** A obrigação de confidencialidade vigora a partir da assinatura e **perdura por prazo indeterminado**, sobrevivendo ao término, à resolução, à resilição ou à nulidade deste contrato, e não se extingue com o pagamento ou o inadimplemento de qualquer parcela. Quanto a segredos de negócio, a obrigação é **perpétua**.

**7.4. Exceções.** Não há violação quando a informação: **(a)** for comprovadamente de domínio público sem culpa do PRESTADOR; ou **(b)** tiver de ser revelada por ordem judicial ou determinação de autoridade competente, hipótese em que o PRESTADOR notificará o CONTRATANTE **imediatamente e previamente**, quando legalmente possível, para permitir-lhe adotar as medidas de proteção cabíveis, limitando-se a revelação ao estritamente exigido.

**7.5. Incidente.** Em caso de vazamento, acesso indevido ou perda de Informação Confidencial, o PRESTADOR comunicará o CONTRATANTE em **até 24 (vinte e quatro) horas** do conhecimento do fato, colaborando integral e gratuitamente na contenção, na investigação e na mitigação.

---

## CLÁUSULA 8 — DA NÃO CONCORRÊNCIA

**8.1. Durante a vigência.** O PRESTADOR obriga-se a **não** prestar serviços, desenvolver, assessorar, sociar-se, investir ou participar, direta ou indiretamente, por si, por interposta pessoa, por pessoa jurídica de que participe ou como colaborador de terceiro, em **qualquer produto, aplicativo, plataforma, SaaS ou solução tecnológica concorrente** das soluções objeto deste contrato ou dirigida ao mesmo público-alvo do CONTRATANTE (contabilidade, auditoria fiscal e tributária, assessoria jurídica e empresarial, gestão trabalhista, BI financeiro, educação empresarial e pré-investimento), salvo autorização prévia e escrita do CONTRATANTE.

**8.2. Após o término.** Pelo prazo de **24 (vinte e quatro) meses** contados do término ou da rescisão deste contrato, por qualquer motivo, o PRESTADOR obriga-se a não praticar as condutas do item 8.1, observados os seguintes limites:

**a) Escopo material:** produtos, aplicativos, plataformas ou soluções SaaS voltados aos segmentos indicados no item 8.1, ou que sejam concorrentes, substitutivos ou derivados das soluções OCEO e Hub GSena;
...
**8.5. Não depreciação.** As PARTES obrigam-se a não praticar atos ou declarações que depreciem, denigram ou exponham negativamente a outra PARTE, seus sócios, suas empresas, suas marcas ou os projetos, durante e após a vigência.
...
**a)** **nada se adquire antes de completado o *cliff*** de 12 (doze) meses previsto no item 9.4(b);
**b)** completado o *cliff*, considera-se adquirido **de uma só vez** o correspondente aos 12 (doze) meses já transcorridos, isto é, **12/48, equivalentes a 2,5% (dois vírgula cinco por cento)** do capital social;
...
## CLÁUSULA 10 — DA GARANTIA TÉCNICA

**10.1.** O PRESTADOR garante o funcionamento das entregas conforme as especificações aprovadas, obrigando-se a corrigir, **sem qualquer custo adicional**, defeitos, erros e vícios identificados no prazo de **`[90]` (noventa) dias** contados de cada aceite, com prazo de atendimento de até `[48]` horas para falhas críticas que impeçam o uso do sistema.

**10.2.** Não são cobertos pela garantia os problemas decorrentes de alteração do código por terceiros, uso indevido, mudança de ambiente ou falha de serviços de terceiros, salvo se decorrentes de erro de arquitetura ou de implementação atribuível ao PRESTADOR.

---

## CLÁUSULA 11 — DA PROTEÇÃO DE DADOS (LGPD)

**11.1.** No tratamento de dados pessoais decorrente deste contrato, o CONTRATANTE atua como **Controlador** e o PRESTADOR como **Operador**, nos termos da Lei nº 13.709/2018 (LGPD).

**11.2.** O PRESTADOR obriga-se a: **(a)** tratar dados pessoais **exclusivamente** conforme as instruções documentadas do CONTRATANTE e na medida estritamente necessária à execução; **(b)** não usar, compartilhar, comercializar, transferir a terceiros ou a outro país, nem tratar para finalidade própria, qualquer dado pessoal; **(c)** adotar medidas de segurança técnicas e administrativas adequadas; **(d)** manter registro das operações de tratamento; **(e)** comunicar o CONTRATANTE em **até 24 (vinte e quatro) horas** de qualquer incidente de segurança; **(f)** auxiliar o CONTRATANTE no atendimento a requisições de titulares e de autoridades, inclusive da ANPD; e **(g)** eliminar ou devolver todos os dados pessoais ao término do contrato, salvo obrigação legal de retenção.

**11.3.** O PRESTADOR responde e indeniza regressivamente o CONTRATANTE por sanções administrativas, condenações, custos e despesas decorrentes de tratamento irregular a ele imputável.
...
**13.1.** Este contrato poderá ser extinto: **(a)** por acordo escrito entre as PARTES; **(b)** por resilição imotivada de qualquer PARTE, mediante aviso prévio escrito de **`[30]` (trinta) dias**; ou **(c)** por resolução, de imediato e sem aviso prévio, por justa causa, em caso de descumprimento de qualquer obrigação contratual não sanado no prazo de 10 (dez) dias da notificação — sendo **insanáveis e de rescisão imediata** as violações às Cláusulas 3.1(e), 6, 7 e 8.

**13.2.** Extinto o contrato por qualquer motivo, o PRESTADOR obriga-se a, no prazo máximo de **5 (cinco) dias corridos**: **(a)** entregar todo o material previsto na Cláusula 3.1(c) e (d); **(b)** realizar transferência ordenada de conhecimento (*handover*) ao CONTRATANTE ou a quem este indicar, por até `[15]` dias, remunerada apenas se a rescisão não decorrer de justa causa a ele imputável; e **(c)** firmar declaração de devolução/destruição integral de informações e códigos.

**13.3.** A recusa, o atraso ou a entrega incompleta do previsto no item 13.2 sujeita o PRESTADOR à multa da Cláusula 15, autoriza a retenção de valores eventualmente devidos e a busca de tutela específica, inclusive liminar de busca e apreensão e de obrigação de fazer.

---

## CLÁUSULA 14 — DA IRRETRATABILIDADE DA CESSÃO

**14.1.** A cessão de direitos da Cláusula 6 é **irretratável e irrevogável**, não se desfaz pela extinção deste contrato, por rescisão de qualquer natureza, por inadimplemento do CONTRATANTE, por distrato ou por decisão judicial que discuta a remuneração, permanecendo íntegra a titularidade do CONTRATANTE sobre todas as criações em qualquer cenário.
...
## CLÁUSULA 16 — DAS DISPOSIÇÕES GERAIS E DO FORO

**16.1.** Este instrumento, com seus Anexos, constitui o **acordo integral** entre as PARTES sobre a matéria, substituindo tratativas, propostas, e-mails, mensagens e ajustes verbais anteriores.

**16.2.** Alterações somente terão validade se formalizadas por escrito e assinadas por ambas as PARTES, ressalvada a atualização do ANEXO I na forma do item 1.2.

**16.3.** A tolerância quanto ao descumprimento de qualquer obrigação não implica novação, renúncia, perdão ou alteração do pactuado.

**16.4.** A eventual nulidade ou ineficácia de qualquer cláusula não contamina as demais; havendo declaração de excesso quanto a prazo, território ou escopo das Cláusulas 7 ou 8, as PARTES autorizam desde já sua **redução ao limite máximo admitido**, preservando-se a restrição no que for válido.
...
1. \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ Nome: `[ ]` — CPF: `[ ]`
2. \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ Nome: `[ ]` — CPF: `[ ]`

---

# ANEXO I — PROJETOS ABRANGIDOS

Rol **exemplificativo**, atualizável na forma do item 1.2. Todos de titularidade exclusiva do CONTRATANTE.
...
# ANEXO II — ESCOPO, MARCOS E CRONOGRAMA

| Marco | Entrega | Prazo | Valor | Aceite |
|---|---|---|---|---|
| 1 | `[ ]` | `[ ]` | R$ `[ ]` | `[ ]` |
| 2 | `[ ]` | `[ ]` | R$ `[ ]` | `[ ]` |

**Critérios de aceite:** `[definir]` · **Prazo de validação pelo CONTRATANTE:** `[ ]` dias.

---

# ANEXO III — MATERIAL PREEXISTENTE DO PRESTADOR

`[Se em branco ou não assinado, presume-se que NÃO há material preexistente e a cessão da Cláusula 6 é integral.]`

| # | Componente | Titularidade / origem | Licença ao CONTRATANTE |
|---|---|---|---|
| | | | |
...
| Carência (*cliff*) | 12 meses — nada adquirido antes disso |
...
|---|---|---|---|
| 6 meses | 31/01/2027 | nada (dentro do *cliff*) | 0% |
| 11 meses | 30/06/2027 | nada (dentro do *cliff*) | 0% |
| **12 meses (*cliff*)** | **31/07/2027** | **12/48, de uma só vez** | **2,50%** |
| 18 meses | 31/01/2028 | 18/48 | 3,75% |
| 24 meses | 31/07/2028 | 24/48 | 5,00% |
...
# ANEXO V — TERMO DE ENTREGA E CESSÃO POR MARCO
...
13. **⚠ A participação subiu de 1% para 10% (v2) — o que muda na prática.** Não é só um número dez vezes maior; muda a natureza da coisa. Três pontos:
    - **Vesting gradual foi ativado (item 9.4.1), com *cliff* de 12 meses.** Sem *vesting*, bastaria o Cid cumprir a carência pra levar os 10% inteiros. Agora a aquisição é de 1/48 ao mês: no *cliff* ele trava **2,5%** de uma vez (os 12 meses já corridos) e só completa os 10% em **48 meses**, em 31/07/2030. Saiu antes, perde o que não venceu, sem aceleração. A escala mês a mês está no ANEXO IV. O desenho é o padrão de mercado (4 anos com *cliff* de 1 ano) — o que te protege é o *vesting* longo, não a carência.
