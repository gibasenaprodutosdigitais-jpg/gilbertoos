# Posicionamento do Gilberto no digital
...
> O que o Gilberto acha que o mercado faz ERRADO? Onde ele discorda do consenso?

- O que quase todo empresário faz errado com imposto e ele vê de outro jeito:
- Uma "verdade" do mercado contábil/tributário que ele acha furada:
...
A reforma é a onda de entrada perfeita: tema quente, todo empresário assustado, e
o Gilberto domina. **E tem urgência real acontecendo neste momento** (ver
`conhecimento/reforma-tributaria.md`):

- **31/jul/2026** — acaba a tolerância dos campos de IBS/CBS na nota
- **03/ago/2026** — destaque de IBS/CBS vira **obrigatório**
- **1 a 30/set/2026** — **janela do Simples Nacional** (decide o imposto de 2027)
- **2027** — PIS/Cofins extintos, CBS pra valer, IPI a zero, Imposto Seletivo, split payment

Conteúdo com **data marcada** é o que mais engaja e mais gera consulta. Enquanto
