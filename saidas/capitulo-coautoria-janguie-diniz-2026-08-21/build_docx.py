...
body(
    "No topo dessa pirâmide está a Gestão de Endividamento — a camada "
    "que mais aprendi, e da forma mais dura, ao longo das sete falências "
    "que atravessei. Dívida, por si só, não é o problema; é ferramenta "
    "legítima de crescimento quando financia ativo produtivo, não quando "
    "cobre rombo operacional recorrente. O erro que mais vejo, e que "
    "mais cometi, é confundir as duas coisas: usar crédito de curto "
    "prazo para tapar buraco estrutural, adiando o problema real em vez "
    "de resolvê-lo. Cada uma das minhas sete quedas teve, na origem, "
    "essa mesma confusão — e é justamente por reconhecer esse padrão, "
    "hoje, de fora, que consigo ajudar outros empresários a interromper "
    "o ciclo antes que ele se repita neles."
)
body(
    "No capítulo de Gestão Financeira do meu livro, transformo essa "
    "pirâmide em algo mais concreto: doze ações práticas que testei e "
    "retesei ao longo de mais de uma década à frente do Grupo Sena. "
    "Convido o leitor a interromper a leitura por um instante e "
    "responder, com honestidade, quantas dessas doze práticas já fazem "
    "parte da rotina do seu negócio: ter orçamento formal; definir "
    "prioridades de gasto; controlar despesas mês a mês; quitar dívidas "
    "antigas antes de assumir novas; criar o hábito de poupar, mesmo que "
    "pouco; montar uma reserva de emergência equivalente a três ou seis "
    "meses de custo fixo; evitar dívida desnecessária; pesquisar preço "
    "antes de qualquer compra relevante; buscar educação financeira de "
    "forma contínua; desenvolver uma fonte de renda extra; planejar toda "
    "compra grande com antecedência; e manter um planejamento financeiro "
    "de longo prazo, não apenas mensal."
)
body(
    "Não é exercício retórico. Na minha experiência prática, "
    "empresários que respondem sim a pelo menos oito dessas doze "
    "perguntas raramente são surpreendidos por uma crise de caixa que "
    "não conseguem atravessar. Os que respondem sim a menos de cinco, "
    "quase sempre, já vivem — ou viveram recentemente — algum grau de "
    "sufoco financeiro sem conseguir nomear a causa exata. A diferença "
    "entre os dois grupos não é o tamanho do negócio, nem o setor em que "
    "atuam. É a disciplina de tratar essas doze ações como rotina, não "
    "como recurso de emergência."
)
body(
    "Essa é, para mim, a dinâmica mais simples e mais subestimada da "
    "Nova Economia: enquanto o mercado celebra modelos de negócio cada "
    "vez mais sofisticados, a maioria das empresas que quebram no Brasil "
    "não quebra por falta de inovação — quebra por falta dessas doze "
    "disciplinas elementares. Antes de perguntar como escalar, o gestor "
    "sério deveria perguntar quantas dessas doze caixas ele já consegue "
    "marcar."
)
body(
    ...
    "portes a recuperar e a preservar milhões de reais que, "
