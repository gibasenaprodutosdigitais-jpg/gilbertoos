# Carrossel — Forjado (anúncio do nome da imersão)

Fontes: `_memoria/quem-e-gilberto.md` (história, 7 falências, fundação Grupo
Sena 2010), `_memoria/tom-de-voz.md` (analogia bíblica), pesquisa `/tendencias`
07/ago/2026 (nomeação de concorrentes: G4 Valley, Summit Êxito, Do Zero ao
Topo Experience — todos usam palavra emprestada do inglês; "Forjado" não
apareceu em nenhum concorrente pesquisado).
...
processo, até que em 2010 nascia o Grupo Sena." — Gilberto Sena
...
> 17/jul/2026 (`carrossel-5gs-gestao-financeira`) — não é a primeira vez que
> o Gilberto conta isso publicamente, não tratar como revelação inédita.
...
**Pendente:** data, local, preço e formato da imersão ainda não estão
fechados (ver `conhecimento/extracao-imersao-empresario-de-escala.md` — a
tabela de precificação do portfólio Imersão + Consultoria está em branco).
Este carrossel anuncia só o **nome** — não prometer data/inscrição até isso
estar decidido.
